...
if __name__ == "__main__":
    ...
    #     train_data_path = ["/data/jiangmeng/ml-1m-split/train/train.json"],
    #     val_data_path = ["/data/jiangmeng/ml-1m-split/valid/valid.json"],
    #     output_dir = "/data/jiangmeng/test/Gen/",
    #     batch_size = 128,
