...
def train(
    ...
    def get_history_bias(datasets):
        ...
        train_genre = pd.read_csv("/home/hexngroup/jiangm/ml-1m-split/movie_pop_count_5.csv")
        ...
        for i in tqdm(range(len(datasets))):
            ...
            for index in input_movie_index:
                ...
                movie_pop = movie_genre["Pop"].iloc[index]
                history_count["%d" % movie_pop] += 1

            next_movie_pop = movie_genre["Pop"].iloc[output_movie_index[0]]
            
            next_count["%d" % next_movie_pop] += 1
    ...
    def get_train_weight(data_point, weight):
        ...
        x = dict()
        x["weight"] = weight["%d" % next_movie_pop]
        return x
