...
def main(
    ...
    base_model: str = "/data/jiangmeng/test/Pretrain_model/hugging_face_LLAMA_weights_7B/",
    lora_weights: str = "/data/jiangmeng/test/Gen",
    test_data_path: str = "/data/jiangmeng/ml-1m-split/test/test.json",
    result_json_data: str = "/data/jiangmeng/test/result/ml-1m_result.json",
    task_type: str = "task1",
